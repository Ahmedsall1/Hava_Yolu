@extends('Layout')
@section('styles')
    <link href="{{ asset('css/bilet.css') }}" rel="stylesheet">
@endsection
@section('content')
    ...
    <div class="container">
        <main class="ticket-system">
            <div class="top">
                ...
                <h1 class="title" id="first-title"> Biletiniz Hazırlanyor <i class="fa-solid fa-hourglass-half"></i></h1>
                <h1 class="title" id="second-title">Biletiniz Hazır <i class="fa-solid fa-circle-check"></i></h1>
                ...
                <div class="receipts-wrapper">
                    <div class="receipts">
                        <div class="receipt">
                            ...
                            <img class="airliner-logo" src="{{ asset($sirket->image) }}" alt="">
                            <div class="route">
                                <h2>{{ strtoupper(substr($sefer->nerden, 0, 3)) }}</h2>
                                ...
                                <h2>{{ strtoupper(substr($sefer->nereye, 0, 3)) }}</h2>
                            </div>
                            <div class="details">
                                <div class="item">
                                    <span>Yolcu</span>
